 ...
 */
function ModelController(tick = 0, fps = 3, running = false, finished = false, datasetNumber = 100) {
    this.tick = tick;
    this.fps = fps;
    ...
    this.updateDatasetNumber = function (val) {
        this.datasetNumber = Number(val)
    }
}

// todo set up a similar control for the number of agents
