...
def test_calculate_operator_utility():
    ...
    pool = Pool(cost=0.001, pledge=0.1, owner=156, margin=0.1, L=0.3, beta=0.1, pool_id=555,
                total_stake=1)
...
def test_calculate_margin_semi_perfect_strategy():
    ...
    pool555 = Pool(cost=0.001, pledge=0.001, owner=156, L=0.3, beta=0.1, pool_id=555, 
                   total_stake=total_stake)
    model.pools[555] = pool555
    pool556 = Pool(cost=0.001, pledge=0.002, owner=157, L=0.3, beta=0.1, pool_id=556, 
                   total_stake=total_stake)
    model.pools[556] = pool556
    pool557 = Pool(cost=0.001, pledge=0.003, owner=157, L=0.3, beta=0.1, pool_id=557, 
                   total_stake=total_stake)
    model.pools[557] = pool557
    pool558 = Pool(cost=0.001, pledge=0.0001, owner=159, L=0.3, beta=0.1, pool_id=558, 
                   total_stake=total_stake)
...
def test_close_pool():
    ...
    pool = Pool(cost=0.001, pledge=0.001, owner=156, margin=0.2, L=0.3, beta=0.1, pool_id=555,
                total_stake=total_stake)
    model.pools[555] = pool
...
def test_determine_pools_to_keep():
    ...
    pool1 = Pool(cost=0.001, pledge=0.001, owner=1, margin=0.2, L=0.3, beta=0.1, pool_id=1,
                 total_stake=total_stake)
    pool2 = Pool(cost=0.001, pledge=0.001, owner=1, margin=0.2, L=0.3, beta=0.1, pool_id=2,
                 total_stake=total_stake)
    pool3 = Pool(cost=0.001, pledge=0.001, owner=1, margin=0.1, L=0.3, beta=0.1, pool_id=3,
                 total_stake=total_stake)
...
def test_find_delegation_move():
    ...
    pool557 = Pool(cost=0.001, pledge=0.003, owner=157, L=0.3, beta=0.1, pool_id=557, 
                   total_stake=total_stake, margin=0.1)
    model.pools[557] = pool557
    pool558 = Pool(cost=0.001, pledge=0.003, owner=158, L=0.3, beta=0.1, pool_id=558, 
...
def test_execute_strategy(mocker):
    ...
    pool1 = Pool(cost=0.001, pledge=0.003, owner=1, L=0.3, beta=0.1, pool_id=1, 
                   total_stake=total_stake, margin=0.1)
    model.pools[1] = pool1
    pool2 = Pool(cost=0.001, pledge=0.002, owner=2, L=0.3, beta=0.1, pool_id=2, 
                   total_stake=total_stake, margin=0)
    model.pools[2] = pool2
    ...
    pool3 = Pool(cost=0.001, pledge=0.001, owner=3, L=0.3, beta=0.1, pool_id=3, 
                 total_stake=total_stake, margin=0)
