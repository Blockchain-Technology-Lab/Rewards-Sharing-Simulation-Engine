...
def test_find_delegation_move():
    ...
    pool557 = Pool(cost=0.001, pledge=0.003, owner=157, a0=0.3, beta=0.1, pool_id=557, reward_function=0,
                   total_stake=total_stake, margin=0.1)
    model.pools[557] = pool557
    pool558 = Pool(cost=0.001, pledge=0.003, owner=158, a0=0.3, beta=0.1, pool_id=558, reward_function=0,
...
def test_execute_strategy(mocker):
    ...
    pool1 = Pool(cost=0.001, pledge=0.003, owner=1, a0=0.3, beta=0.1, pool_id=1, reward_function=0,
                   total_stake=total_stake, margin=0.1)
    model.pools[1] = pool1
    pool2 = Pool(cost=0.001, pledge=0.002, owner=2, a0=0.3, beta=0.1, pool_id=2, reward_function=0,
                   total_stake=total_stake, margin=0)
    model.pools[2] = pool2
    ...
    pool3 = Pool(cost=0.001, pledge=0.001, owner=3, a0=0.3, beta=0.1, pool_id=3, reward_function=0,
                 total_stake=total_stake, margin=0)
